...
# ------------------ STREAMLIT APP ------------------
st.title("Mission Journal Transcriber (Azure OCR + Optional GPT-4 Vision Check)")

use_gpt4_vision = st.sidebar.checkbox("Use GPT-4 Vision to verify and correct Azure OCR?", value=True)
...
if uploaded_files and st.button("Process Files"):
    ...
    for idx, uploaded_file in enumerate(uploaded_files):
        ...
        # Step 3: Optional GPT-4 Vision Check
        if use_gpt4_vision:
